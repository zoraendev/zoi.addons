CREATE TABLE IF NOT EXISTS zrn_prodigyn_commercial_brand (
    ...
    owner_partner_id BIGINT REFERENCES res_partner(id) ON DELETE SET NULL,
    logo BYTEA,
    website VARCHAR,
    email VARCHAR,
    phone VARCHAR,
...
CREATE INDEX IF NOT EXISTS zrn_prodigyn_commercial_brand_owner_idx
    ON zrn_prodigyn_commercial_brand (owner_partner_id);
