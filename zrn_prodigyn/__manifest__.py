...
Modulo principal de Prodigyn.
    ...
    'data': [
        ...
        'views/commercial_planning/commercial_planning_views.xml',
        'views/commercial_planning/placeholders/commercial_placeholder_base_views.xml',
        'views/commercial_planning/placeholders/commercial_brands_views.xml',
        'views/commercial_planning/placeholders/commercial_portfolio_views.xml',
        'views/commercial_planning/placeholders/commercial_customers_views.xml',
        'views/commercial_planning/placeholders/commercial_channels_views.xml',
        'views/commercial_planning/placeholders/commercial_campaigns_views.xml',
        'views/commercial_planning/placeholders/commercial_pricing_views.xml',
        'views/commercial_planning/placeholders/commercial_targets_views.xml',
        'views/commercial_planning/placeholders/commercial_calendar_views.xml',
