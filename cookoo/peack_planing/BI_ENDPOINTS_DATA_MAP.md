...
Este documento resume qué modelos/tablas y qué campos de Odoo consume cada endpoint del dashboard de inventario en `peack_planing`, para facilitar la conexión y trazabilidad desde Power BI.
...
- `custom_addons/cookoo/peack_planing/models/report_wizard.py`
- `custom_addons/cookoo/peack_planing/controllers/inventory_dashboard.py`
