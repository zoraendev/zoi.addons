...
## Resumen
`peack_planing` es un addon de Odoo 17 orientado a exponer reportes operativos para consumo interno y para integraciones tipo BI. Hoy su foco principal es el reporte de planeacion semanal de ventas e inventario, junto con una pantalla home que valida el estado del cliente antes de habilitar el acceso.
...
2. El modelo `peack_planing.inicio` consulta los parametros guardados en `ir.config_parameter`.
...
Archivo:
[models.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/models/models.py)

### `peack_planing.report.wizard`
...
Archivo:
[report_wizard.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/models/report_wizard.py)

### `peack_planing.report.wizard.line`
...
Archivo:
[res_config_settings.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/models/res_config_settings.py)

## Vistas y UI
### Home del modulo
Definida en:
[views.xml](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/views/views.xml)
...
### Vista del reporte
Definida en:
[sales_orders.xml](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/views/sales_orders.xml)
...
### Ajustes
Definidos en:
[res_config_settings.xml](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/views/res_config_settings.xml)

## Controladores HTTP
### `PeackPlaningController`
Archivo:
[controllers.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/controllers/controllers.py)

Rutas principales:
- `/peack_planing/report/next-week-dates`
- `/peack_planing/report/generate`
...
## Assets frontend
### JS
- [home_form_view.js](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/static/src/js/home_form_view.js)
  agrega acciones del control panel para la home.
- [sales_orders_form_view.js](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/static/src/js/sales_orders_form_view.js)
  personaliza el comportamiento del formulario del reporte.
- [sales_orders_report.js](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/static/src/js/sales_orders_report.js)
  maneja generacion, filtros y descarga.

### XML Owl/QWeb
- [home_form_view.xml](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/static/src/xml/home_form_view.xml)

### SCSS
- [dashboard.scss](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/static/src/scss/dashboard.scss)

## Logica de validacion externa
La validacion vive en `peack_planing.inicio`.
...
- `peack_planing.registro` existe como modelo auxiliar pero no tiene reglas de acceso completas.
- El reporte principal esta implementado, pero `action_generate_report` del wizard aun devuelve una notificacion placeholder.

## Archivos clave
- [__manifest__.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/__manifest__.py)
- [models.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/models/models.py)
- [report_wizard.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/models/report_wizard.py)
- [controllers.py](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/controllers/controllers.py)
- [views.xml](C:/dev/odoo/zoraen-odoo/custom_addons/cookoo/peack_planing/views/views.xml)
